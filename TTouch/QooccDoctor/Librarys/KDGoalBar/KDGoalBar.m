...
-(void)setup {
    ...
    percentLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 90, 90)];
    [percentLabel setFont:[UIFont systemFontOfSize:22]];
    [percentLabel setTextColor:[[UIColor alloc] initWithRed:0/255.0 green:97/255.0 blue:165/255.0 alpha:1]];
