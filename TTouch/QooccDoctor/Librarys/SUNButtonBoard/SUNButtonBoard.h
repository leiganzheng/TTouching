...
- (void)buttonBoardClickButtonAtIndex:(NSInteger)index;
...
//按钮板的选中背景图
@property (nonatomic,assign)NSString *boardSelectedImage;
//按钮板背景图
@property (nonatomic,assign)NSString *boardImageString;
...
@property (nonatomic,retain)NSString *backgroundSelectedImage;
