...
class XFengViewController: UIViewController,QNInterceptorProtocol, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cellId = "cell"
        var cell: XFTableViewCell! = self.myCustomTableView.dequeueReusableCellWithIdentifier(cellId) as? XFTableViewCell
        if cell == nil {
            cell = XFTableViewCell(style: UITableViewCellStyle.Default, reuseIdentifier: cellId)
