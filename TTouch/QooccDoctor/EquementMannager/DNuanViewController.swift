...
class DNuanViewController: UIViewController ,QNInterceptorProtocol, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cellId = "cell"
        var cell: DNuanTableViewCell! = self.myCustomTableView.dequeueReusableCellWithIdentifier(cellId) as? DNuanTableViewCell
        if cell == nil {
            cell = DNuanTableViewCell(style: UITableViewCellStyle.Default, reuseIdentifier: cellId)
